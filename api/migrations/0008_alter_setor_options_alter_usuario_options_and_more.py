...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='setor',
            constraint=models.CheckConstraint(condition=models.Q(('nome__regex', '^\\s*$'), _negated=True), name='ck_setor_nome_nao_vazio'),
        ),
        migrations.AddConstraint(
            model_name='usuario',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('email'), name='uq_usuario_email_lower'),
        ),
    ]

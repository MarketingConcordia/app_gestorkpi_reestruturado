# Generated by Django 5.2.3 on 2025-09-01 19:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dia_limite_preenchimento', models.PositiveSmallIntegerField(default=10, help_text='Apenas até esse dia do mês os gestores poderão preencher indicadores.', verbose_name='Dia limite para preenchimento')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_meta', models.CharField(choices=[('crescente', 'Para cima'), ('decrescente', 'Para baixo'), ('monitoramento', 'Monitoramento')], max_length=20)),
                ('status', models.CharField(choices=[('pendente', 'Pendente'), ('concluido', 'Concluído')], default='pendente', max_length=20)),
                ('valor_meta', models.DecimalField(decimal_places=2, default=0, max_digits=10)),
                ('tipo_valor', models.CharField(choices=[('numeral', 'Numeral'), ('monetario', 'Monetário'), ('percentual', 'Percentual')], default='numeral', max_length=20)),
                ('criado_em', models.DateTimeField(auto_now_add=True)),
